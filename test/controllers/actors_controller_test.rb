...
class ActorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post actors_url, params: { actor: { fechanac: @actor.fechanac, nombre: @actor.nombre, nombrereal: @actor.nombrereal } }
    end
  ...
  test "should update actor" do
    patch actor_url(@actor), params: { actor: { fechanac: @actor.fechanac, nombre: @actor.nombre, nombrereal: @actor.nombrereal } }
